...
// OMD_THIRD_PARTY_CHANGE: 1. Made onDisconnect protected to call from subclasses. 2. Added getSessionID function to let collector know session id in onDisconnect function.
protected:
  void onDisconnect( SocketConnector&, int);

  bool getSessionID(SessionID* session_id, int s);
